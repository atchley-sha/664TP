...
## Study Level {#sec-study-level}

\acr{UDOT} Administrative Rule R930-6-8(4) [@utahdepartmentoftransportation2019] sets forth general requirements for an access permit, including determining the application level. The proposed development will contain an 8,000 ft^2^ high-turnover restaurant (\acr{ITE} land use code 932) and a 32,000 ft^2^ office/retail building, half of which (18,000 ft^2^) will be a general office location (\acr{ITE} land use code 710), and the remaining half (18,000 ft^2^) will be a hardware store (\acr{ITE} land use code 816). From the \acr{ITE} Trip Generation Manual [@instituteoftransportationengineers2021], these locations are expected to generate 1264 weekday trips and 162 PM peak trips (see @sec-trip-generation and @sec-apdx-tripgen). These trip rates, along with the land use and respective development sizes, necessitate a level II application.
